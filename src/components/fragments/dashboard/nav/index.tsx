...
export default function Navbar() {
    return (
        <Box
            ...
            borderBottom={"5px solid #000"} // Garis tegas untuk kesan brutalism
        >
            <Flex
                w={"100%"}
                h={"100%"}
            ...
            >
                ...
                <Flex alignItems="center" gap="4">
                    <Link to="/dashboard">
                        <Button
                            bg={"#64748b"} // Warna latar belakang tombol
                    ...
                    <Link to="/dashboard/product">
                        <Button
                            ...
                            color={"#000"}
                            borderRadius={"0"}
                            border={"3px solid #000"} // Border lebih tegas
                            fontWeight={"bold"}
                            position="relative"
                            boxShadow="5px 5px 0px black" // Shadow hitam menjorok
                            transition="transform 0.2s ease, box-shadow 0.2s ease" // Efek transisi
                            _hover={{
                                transform: "translate(5px, 5px)", // Tombol bergerak
                                boxShadow: "0px 0px 0px black", // Menghapus shadow saat hover
                                bg: "#00bfff", // Mengubah warna latar saat hover
                            }}
                            _active={{
                                transform: "translate(2px, 2px)", // Tombol bergerak sedikit saat ditekan
                                boxShadow: "inset 2px 2px 0px black", // Shadow masuk ke dalam
                    ...
                    <Link to="/dashboard/category">
                        <Button
                            ...
                            _hover={{
                                transform: "translate(5px, 5px)", // Tombol bergerak
                                boxShadow: "0px 0px 0px black", // Menghapus shadow saat hover
                                bg: "#e60045", // Mengubah warna latar saat hover
                            }}
                            _active={{
                                transform: "translate(2px, 2px)", // Tombol bergerak sedikit saat ditekan
                                boxShadow: "inset 2px 2px 0px black", // Shadow masuk ke dalam
